...
Projet MLOps complet pour la détection d'objets (YOLO tiny) utilisant un pipeline **ZenML** orchestré, avec **MLflow** pour le tracking, **MinIO** pour le stockage d'artefacts S3-compatible, et **DVC** pour le versioning des données.
...
# Si besoin d'ajouter manuellement (Alternative à dvc repro)
